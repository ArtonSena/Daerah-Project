  ...
  return (
    <footer className="bg-white text-gray-700 py-12 mt-20 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between gap-10">
        <div>
          <h2 className="text-2xl font-bold text-red-500 mb-3">IndoExplore</h2>

          <p className="text-sm text-gray-500 max-w-sm leading-relaxed">
            Platform eksplorasi wilayah Indonesia yang dirancang simpel, cepat,
            dan informatif. Temukan provinsi, kabupaten, dan pulau dengan
            pengalaman yang lebih modern.
          </p>
        </div>
